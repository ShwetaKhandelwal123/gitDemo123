...
//		
	...
	driver.findElement(By.xpath("//*[@id=\"insurance-form\"]/div/section[2]/div[10]/p/label[1]/span")).click();
		...
		Select courtesycar=new Select(dropdown8);
		...
		String ExpPrice="88.00",ExpOnlineClaim="No",ExpClaimDiscount="No",ExpWWCover="No";
