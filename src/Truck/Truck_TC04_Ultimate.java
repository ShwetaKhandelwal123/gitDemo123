...
public class Truck_TC04_Ultimate {
	...
	public static void main(String[] args) {
		...
		//payload
		driver.findElement(By.id("payload")).sendKeys("198");
		
		//total weight
		driver.findElement(By.id("totalweight")).sendKeys("2222");
		...
		//license plate no.
		driver.findElement(By.id("licenseplatenumber")).sendKeys("MH14 SG608");
	...
	driver.findElement(By.xpath("//*[@id=\"insurance-form\"]/div/section[2]/div[10]/p/label[1]/span")).click();
		...
		//select price option(Ultimate)
		String ExpPrice="1,385.00",ExpOnlineClaim="Submit",ExpClaimDiscount="10",ExpWWCover="Unlimited";
		System.out.println("Ultimate price:");
		String actPrice=driver.findElement(By.xpath("//*[@id=\"selectultimate_price\"]")).getText();
				//(By.xpath("//*[@id=\"priceTable\"]/tbody/tr[2]/td[2]"));
