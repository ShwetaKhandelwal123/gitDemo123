...
public class Truck_TC02_Gold {
	...
	driver.findElement(By.xpath("//*[@id=\"insurance-form\"]/div/section[2]/div[10]/p/label[1]/span")).click();
		...
		double ExpPrice=370.00;
		String ExpOnlineClaim="Submit",ExpClaimDiscount="2",ExpWWCover="Limited";
		System.out.println("Gold price:");
		WebElement actPrice=driver.findElement(By.xpath("//*[@id=\"priceTable\"]/tbody/tr[1]/td[3]"));
