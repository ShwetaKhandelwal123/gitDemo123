...
public class Camper_TC03_Platinum {
	...
	driver.findElement(By.xpath("//*[@id=\"insurance-form\"]/div/section[2]/div[10]/p/label[1]/span")).click();
		...
		String ExpPrice="642.00",ExpOnlineClaim="Submit",ExpClaimDiscount="5",ExpWWCover="Limited";
		System.out.println("platinum price:");
		WebElement actPrice=driver.findElement(By.xpath("//*[@id=\"priceTable\"]/tbody/tr[1]/td[4]"));
